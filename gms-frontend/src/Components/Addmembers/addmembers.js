...
const fetchMembership=async()=>{
  await axios.get('https://gymsync-herc.onrender.com/plans/get-membership', {withCredentials:true}).then((response)=>{
...
await axios.post('https://gymsync-herc.onrender.com/members/register-member',inputField,{withCredentials:true}).then((res)=>{
